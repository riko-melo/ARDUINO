...
//função para desenhar o simbolo da temperatura no lcd
byte tmp[8] = { 0b00100, 0b01010, 0b01010, 0b01110, 0b01110, 0b11111, 0b11111, 0b01110};

ESP8266WiFiMulti wifiMulti; //Cria uma instancia da classe ESP8266WiFiMulti para conectar as redes WiFi

WiFiUDP udp;
NTPClient ntp(udp, "a.st1.ntp.br", -3 * 3600, 60000);

#define pinDHT D3 // Pino atribuido ao sensor DHT11
#define DHTTYPE DHT11 // Indicação do modelo de sensor, no caso DHT 11
DHT dht(D3, DHT11); //Declaração de objeto dht para receber dados do sensor
...
void setup()
{
  ...
  wifiMulti.addAP("iPhone8", "riko2019");
